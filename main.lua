...
include("scripts.ST_onRoomClear")
...
include("scripts.ST_statusEffects")
...
PST:AddCallback(ModCallbacks.MC_PRE_NEW_ROOM, PST.preNewRoom)
PST:AddCallback(ModCallbacks.MC_POST_NEW_LEVEL, PST.onNewLevel)
...
PST:AddCallback(ModCallbacks.MC_POST_EFFECT_INIT, PST.onEffectInit)
PST:AddCallback(ModCallbacks.MC_POST_EFFECT_UPDATE, PST.onEffectUpdate)
...
PST:AddPriorityCallback(ModCallbacks.MC_PRE_USE_ITEM, CallbackPriority.EARLY, PST.preUseItem)
...
PST:AddCallback(ModCallbacks.MC_PRE_FAMILIAR_COLLISION, PST.preFamiliarCollision)
...
PST:AddCallback(ModCallbacks.MC_POST_GRID_ROCK_DESTROY, PST.gridEntityRockDestroy)
PST:AddCallback(ModCallbacks.MC_PRE_PLANETARIUM_APPLY_TELESCOPE_LENS, PST.onPlanetariumChance)
PST:AddCallback(ModCallbacks.MC_POST_PLANETARIUM_CALCULATE, PST.finalPlanetariumChance)
...
PST:AddCallback(ModCallbacks.MC_PRE_STATUS_EFFECT_APPLY, PST.preStatusEffectApply)
PST:AddCallback(ModCallbacks.MC_POST_STATUS_EFFECT_APPLY, PST.postStatusEffectApply)
