...
-- Default menu input mask
PST.menuInputMask = 4294967295
...
function PST:resetMods()
	...
	PST.treeMods = {
		...
		championXP = 0,
		championChest = 0,
		championChestDrops = 0,
		championStoneChest = 0,
		championMaxChests = 0,
		spikedChestReplace = 0,
		chargedKeyConv = 0,
		clearThrowableBomb = 0,
		deadlySinKey = 0,
		deadlySinBattery = 0,
		donoEntranceRestore = 0,
		donoPurchaseRestore = 0,
		donoPurchaseThresh = 0,
		generosityInSteps = false,
		generosityInStepsCount = 0,
		bossRushTimer = 0,
		beasthunterRush = false,
		hushTimer = 0,
		bossLockedChest = 0,
		bossRedChest = 0,
		bossStoneChest = 0,
		...
		treasureDoubleHeart = 0,
		bloodcrowned = false,
		bloodcrownedProc = false,
		---- Azazel's Tree ----
		...
		boonGenerosity = 0,
		boonProtection = 0,
		boonLethargyChance = 0,
		boonLethargyLen = 0,
		boonLethargyMinSpd = 0,
		boonHorrorChance = 0,
		boonHorrorLen = 0,
		boonHorrorDmg = 0,
		boonHypnoChance = 0,
		...
		boonActivity = 0,
		boonEmptinessDmg = 0,
		boonEmptinessTears = 0,
		boonVolatilityDmg = 0,
		boonVolatilityBombs = 0,
		boonImpCharges = 0,
		boonChampSlayDmg = 0,
		boonChampSlayMax = 0,
		boonChampSlayBuff = 0,
		...
		-- Curses
		curseInvFortune = 0,
		curseInvFortuneMax = 0,
		curseResilience = 0,
		curseEphPieces = 0,
		cursePowerDemandCharges = 0,
		cursePowerDemandScarcity = 0,
		curseGiantsFort = 0,
		curseGreaterExpenses = 0,
		curseFlimGadgDrop = 0,
		curseFlimGadgVanish = 0,
		curseAbundantMightChance = 0,
		curseAbundantMightDmgRed = 0,
		curseVanishingWealth = 0,
		cursePrecarious = 0,
		curseUnexpectedTax = 0,
		curseFadingKeys = 0,
		cursePunishment = 0,
		cursePunishmentCount = 0,
		curseMortality = false,
		curseDimPowerLaser = 0,
		curseDimPowerExpl = 0,
		curseHeartbroken = 0,
		-- Objective
		expedSelNodeCol = -1,
