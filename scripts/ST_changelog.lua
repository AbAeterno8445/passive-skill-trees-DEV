function PST:getChangelogList()
    local changelog = {
        ...
        "",
        "v0.2.28",
        "- Crimson Warpstone: chance to drop Cracked Keys on room clear now gains a bonus from the Womb onwards.",
        "Bonus doesn't apply while in the ascent or in red rooms themselves.",
