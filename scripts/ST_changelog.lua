function PST:getChangelogList()
    local changelog = {
        ...
        "arcane obols for you after certain events. Companions can be leveled up by fulfilling their objective, and grant an additional",
        "bonus when reaching their maximum of level 3.",
        "Fully leveling companions additionally grants permanent rewards such as Global Skill Points and Ancient Stardust.",
        "To obtain companions, you must first allocate the companions node, find their eggs, then hatch them in the Incubator nodes by",
        ...
        "- The Obscure Bazaar in the Star Tree now sells Ancient Stardust.",
        "WEAPONS:",
        ...
        "- Viper Stinger (Ancient Spear weapon) now only doubles paralysis on-hit chance and duration against non-boss enemies, and",
        "no longer refreshes paralysis duration on proc against already paralyzed enemies.",
        "- Mobripper (Ancient Scythe weapon) slashes now deal up to 300% of the hit's damage (from 350%). Now grants -35-25% damage (from -25-15%).",
        ...
        "FIXES:",
        "- Fixed Divine Interceptor (Ancient Sword weapon)'s upgrade effects not working. Its cooldown is now lowered slightly when upgrading, and",
        "its effect can now trigger when hitting enemies within 3 tiles (from 2).",
        ...
        "- The \"Bloodshield\" Crimson Convergence buff now grants 0.05 seconds of invulnerability per crimson starcore (from 0.1).",
        "- The \"Starstruck\" Crimson Convergence buff now grants +2% obols found per crimson starcore (from 3%).",
        "- Increased base obol prices for Obscure Bazaar items.",
        "- Uber expeditions' implicit obol increase is now 15% (from 25%).",
        "- Monster HP modifiers no longer get reduced effectiveness on floors 3 and 4 in uber expeditions.",
        ...
        "- Made adjustments to Uber Expeditions (most of these will apply to newly generated expeditions):",
        "    - Order nodes are now far more common, and these remove entropy modifiers from affected nodes.",
        "    - Order nodes now contain 2 random objectives that grant order when completed while the node is selected.",
        "    - Many order node objectives are repeatable within the run up to a maximum.",
