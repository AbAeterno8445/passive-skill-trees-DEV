PST.sideArtiData = {
    ...
    rotseekerSeptentrion = {
        ...
        objective = { -- TEST
            desc = "Inflict status effects on bosses {{progress}}/30 times.",
            req = 30
        },
        energy = 3
    },
    ...
    smitingMeridion = {
        ...
        objective = { -- TEST
            desc = "Clear {{progress}}/30 rooms within 8 seconds each.",
            req = 30
        },
        energyReq = 35,
        cooldown = 5
    ...
    infectiousMeridion = {
        ...
        objective = { -- TEST
            desc = "Inflict status effects on non-boss enemies {{progress}}/150 times.",
            req = 150
        },
        energyReq = 25,
        cooldown = 4
    ...
    brimMeridion = {
        ...
        objective = { -- TEST
            desc = "Kill {{progress}}/150 monsters with lasers.",
            req = 150
        },
        energyReq = 45
    },
